    ...
    def scrape(urlOriginal,data_list):
        ...
        for value in range(1,2):
            ...
            for container in article_1:
                ...
                if category == 'TOURISM & SIGHTSEEING' and image == 'None':
                    image = 'https://www.fhi.no/globalassets/bilder/vaksine/oversikt-reisevaksine.jpg?preset=mainbodywidth'

...
export const getEvents = () => dispatch => {
    ...
    axios
      .get('http://localhost:5001/evea-prj/us-central1/api') 
      .then(function(res) { 
  ...
  export const getEventDetails = title => dispatch => {
    // dispatch({ type: LOADING_DATA });
    axios
      .get(`http://localhost:5001/evea-prj/us-central1/api/eventDetails/${title}`) 
      .then(res => 
        dispatch({
  ...
  export const getRecmdEvents = title => dispatch => {
    ...
    axios 
      .get(`http://localhost:5001/evea-prj/us-central1/api/recommendationData/${title}`)
      .then(res => 
        dispatch({
